...
export const InstructorForm: FunctionComponent<Props> = () => {
  const {
    register,
    formState: { errors },
    handleSubmit,
  ...
  return (
    <>
      ...
      <div className="register__form--instructor">
        <div
        ...
        <DropDown
          ...
          refs={register("employmentType", { required: "Field is required" })}
          error={errors["employmentType"]}
          styles={{ gridArea: "employmentType" }}
        />
        <div
